...
MSB_TextStyle = MSB_Class()

function MSB_TextStyle:IsDark()
...
function MSB_TextStyle:ApplyToSpell(nameFS, subFS, lightBorder, mode)
...
MSB_TextStyleInstance = MSB_TextStyle:New()
